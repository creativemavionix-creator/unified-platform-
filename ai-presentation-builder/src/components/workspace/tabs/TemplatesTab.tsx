...
import { TEMPLATE_LIBRARY, FEATURED_THEMES } from '../../../data/presentationMockData';
      ...
      <div>
        ...
        <div className="mt-3 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {FEATURED_THEMES.map((t) => (
            <button key={t.id} className="group relative aspect-[4/3] rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-700 transition-colors">
            ...
            <div key={t.id} className="group rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-700 hover:-translate-y-0.5 transition-all">
              <div className="relative aspect-video bg-slate-100 dark:bg-slate-900 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-colors flex items-center justify-center">
                  <button className="opacity-0 group-hover:opacity-100 transition-opacity inline-flex items-center gap-1.5 rounded-full bg-white px-3.5 py-1.5 text-[11px] font-black text-purple-700">
