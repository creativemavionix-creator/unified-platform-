...
export const AI_SUGGESTIONS = [
  'Add a market-sizing slide — decks with TAM/SAM/SOM convert 22% better with investors.',
  'Your "Annual Report 2026" is missing speaker notes on 6 slides.',
  'Try the Aurora theme for the Q3 Product Launch — it matches your brand palette.',
  'Compress 3 slides in "Onboarding Training Deck" into a single smart layout.',
];
